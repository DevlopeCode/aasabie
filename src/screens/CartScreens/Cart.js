    ...
    <ScrollContainer header={<Header title="Cart" />}>
      <View style={{flex: 1, backgroundColor: 'white'}}>
        ...
        <FlatList
          ...
          renderItem={({item, index}) => (
            <View
              ...
              <Text style={{fontSize: vs(8), marginLeft: 2, fontWeight: '500'}}>
                Pattern Design Cover Up
              </Text>
        ...
        <View style={{marginHorizontal: wp(5), marginTop: 30}}>
          ...
          <Text style={{marginTop: 10, fontSize: vs(11), color: '#EC303A'}}>
          ...
          <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
            <View>
              ...
              <Text
                style={{fontWeight: 'bold', marginTop: 8, color: '#EC303A'}}>
                Order Total
              </Text>
            </View>
            <View>
