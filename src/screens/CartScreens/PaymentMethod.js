  ...
  return (
    <View style={{flex: 1, backgroundColor: 'white'}}>
      ...
      <View style={{paddingHorizontal: wp(6)}}>
        ...
        <AccordionComponent  style={{borderBottomWidth: 0}} title="Cash on Delivery" />
        <View style={{height:13, backgroundColor:'#F5F6FA', borderTopWidth:2, borderTopColor:'#eef0f6'}} />
        <View
          style={{
            flexDirection: 'row',
        ...
        <View style={{height:13, backgroundColor:'#F5F6FA', marginTop:15}} />
