    ...
    <ScrollContainer>
      <View style={styles.container}>
        ...
        <View style={{flex: 1, paddingLeft: '7%', paddingTop: '10%'}}>
          <RowLable Icon={AccountInformation} title={'Account Information'} onPress={()=> navigation.navigate('AccountInformation')} />
          ...
          <RowLable Icon={Coupons} title={'Coupons'} onPress={()=>navigation.navigate('MyCoupons')}/>
