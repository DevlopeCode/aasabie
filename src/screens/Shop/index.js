...
import {SafeAreaView, Animated, StyleSheet, ActivityIndicator, View} from 'react-native';
...
const ShopScreen = () => {
  ...
  return (
    <Stack.Navigator screenOptions={options} initialRouteName="Shop">
      <Stack.Screen name="Shop" component={Shop} />
      <Stack.Screen name="SummerScreen" component={SummerScreen} />
    </Stack.Navigator>
  );
};
