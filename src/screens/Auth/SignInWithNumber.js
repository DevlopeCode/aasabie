      ...
      <View style={styles.restContainer}>
       ...
       {/* <NumberInput/> */}
        ...
        <View style={styles.BtnGroup}>
          {/* SignIn Button */}
          <SquareButton text={"REQUEST OTP"} Txtclr={"white"} bgclr={"black"} onPress={handleLogin} />
          
          <View style={styles.dividerContainer}>

            <View><Text style={styles.divider}>─────────</Text></View>
            <View><Text style={styles.dividerTxt}>Or Sign in with Google</Text></View>
            <View><Text style={styles.divider}>─────────</Text></View>
          </View>
          
          {/* SignInWithGoogleButton */}
          <SignInWithGoogleButton text={"Sign in"} Txtclr={"white"} bgclr={"black"} />
        </View>
