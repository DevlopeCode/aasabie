  ...
  return (
    <SafeAreaView>
      ...
      <View style={styles.searchBar}>
        <BackArrowIcon color={color.primary} size={7} />
      ...
      {/* Banner IMG */}
      <TouchableWithoutFeedback>
          <Image style={styles.bannerImg} source={require("../../assets/images/Apparel/PNG FILES/image 61.png")} />
      </TouchableWithoutFeedback>
